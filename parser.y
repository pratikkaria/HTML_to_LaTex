...
//-------------------------------------------------GRAMMER for Data/Greek Symbols/Comments------------------------------------------
data		:	data	DATA								{		
													$$ = new_node();
													string str($2);
													string st1("");
